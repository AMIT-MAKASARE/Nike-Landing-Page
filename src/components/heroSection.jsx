            ...
            <div className="texts">
             ...
             <div className="socialMedia">
                ...
                <div className="socailMediaimgs">
                  <img src="/img/4331d1d3fe15236a1a9843e35f7b3b8467e998ff.png" alt="" />
                  <img src="/img/9669ba8f4f98c0bc6952e9281673372fcb16cfc0.png" alt="" />
                 </div>
             </div>
            </div>
            <div className="mainImg">
                <img className="shoeImg" src="/img/shoe_image.png" alt="shoes" />
            </div>
          </div>
        </>
     );
